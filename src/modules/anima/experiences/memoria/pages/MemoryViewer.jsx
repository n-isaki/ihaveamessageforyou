  ...
  if (loading)
    return (
      <div className="h-screen bg-[#faf9f6] flex items-center justify-center">
        <Loader className="animate-spin text-stone-400" />
      </div>
    );
  if (!gift)
    return (
      <div className="h-screen bg-[#faf9f6] flex items-center justify-center text-stone-500">
    ...
    <div className="min-h-screen bg-[#faf9f6] text-stone-800 font-serif selection:bg-stone-200">
      ...
      <div className="max-w-2xl mx-auto px-6 py-16 flex flex-col items-center">
        ...
        >
          ...
          <h1
            className="text-5xl md:text-6xl lg:text-7xl font-normal text-stone-900 mb-6 tracking-wide leading-tight"
        ...
        >
          ...
          <ReactMarkdown
            components={{
              p: ({ ...props }) => (
                <p
                  className="text-xl leading-loose text-stone-600 font-light"
                  style={{ fontFamily: '"Crimson Pro", serif' }}
                  {...props}
                />
              ),
        ...
        <div className="mt-32 opacity-30 text-center">
          ...
          <a
            ...
            target="_blank"
            className="text-[10px] uppercase tracking-[0.2em] hover:text-stone-900 transition-colors"
          >
            www.kamlimos.com
          </a>
        </div>
