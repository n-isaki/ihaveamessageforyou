    ...
    <div className="min-h-screen bg-white p-8">
      ...
      <div className="max-w-2xl mx-auto border-4 border-rose-100 rounded-3xl p-12 text-center space-y-8 print:border-4 print:p-8">
        <div className="space-y-2">
          <h1 className="text-4xl font-serif text-rose-600">
            Ein Geschenk für dich
          </h1>
          <p className="text-xl text-stone-600">
            So siehst du deine persönliche Nachricht:
          </p>
        </div>

        <div className="bg-stone-50 rounded-2xl p-6 text-left space-y-3 print:bg-white print:border print:border-stone-200">
          ...
          <ol className="text-stone-600 text-sm space-y-2 list-decimal list-inside">
            <li>
              <strong>QR-Code scannen</strong> – Halte deine Handykamera auf den
              Code unten. Es öffnet sich automatisch die Nachricht.
            </li>
            <li>
              <strong>Oder ohne Scanner:</strong> Öffne im Browser die Website{" "}
              <span className="font-mono text-stone-800 text-xs break-all">
                {baseUrl}
              </span>{" "}
              und gib dort deinen PIN-Code ein (steht unten).
            </li>
          </ol>
        </div>
        ...
        <p className="text-stone-500 text-sm -mt-2">
          ↑ Mit Handykamera scannen
        </p>

        <div className="space-y-4">
          <div className="inline-block bg-stone-100 px-6 py-4 rounded-lg print:bg-transparent print:border print:border-stone-200">
            <p className="text-sm text-stone-500 uppercase tracking-wider font-semibold">
              Dein PIN-Code (falls du nicht scannen möchtest)
            </p>
            <p className="text-3xl font-mono font-bold text-stone-900 tracking-widest mt-1">
              {gift.accessCode}
            </p>
            <p className="text-xs text-stone-500 mt-2">
              Diesen Code auf der Website eingeben → Nachricht öffnet sich.
            </p>
          </div>
        </div>
