  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (createdGift) {
        ...
        const name =
          memoriaForm.customerName || memoriaForm.senderName || "Kunde";
...
${setupUrl}`;
        ...
        alert(
          `Memoria-Auftrag erstellt!\n\nEine Nachricht mit Anleitung und deinem Link wurde in die Zwischenablage kopiert. Sende sie an den Kunden (z. B. per E-Mail oder WhatsApp).`
        );
      }
