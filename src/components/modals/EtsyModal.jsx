      ...
      if (etsyForm.productType === "memory-card") {
        ...
        if (createdGift) {
          ...
          const baseUrl = isStaging
            ...
            : "https://memoria.kamlimos.com";
          const setupUrl = `${baseUrl}/setup/${giftId}${tokenPart}`;
          const name = etsyForm.buyerName || "Kunde";
          const message = `Hallo ${name},

dein Memoria-Geschenk ist angelegt. So geht es weiter:

1. Öffne den Link unten (der Link ist nur für dich gültig).
2. Fülle die Angaben aus: Name des Verstorbenen, Lebensdaten und deine Geschichte für Audio & Text.
3. Klicke auf „Absenden & Versiegeln“. Danach starten wir die Fertigung.

Dein persönlicher Link:
${setupUrl}`;
          navigator.clipboard.writeText(message);
          alert(
            `Memoria-Auftrag erstellt!\n\nEine Nachricht mit Anleitung und deinem Link wurde kopiert. Sende sie an den Kunden (z. B. per E-Mail oder WhatsApp).`
          );
        }
      } else {
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setEtsyForm({ ...etsyForm, productType: e.target.value })
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEtsyForm({ ...etsyForm, buyerName: e.target.value })
                  }
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEtsyForm({ ...etsyForm, buyerEmail: e.target.value })
                  }
                />
              </div>
