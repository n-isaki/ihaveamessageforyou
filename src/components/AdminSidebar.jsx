  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`p-6 pb-4 flex items-center border-b border-[#3A3A3A] ${collapsed ? "justify-center" : "justify-between"}`}
        >
          {!collapsed && (
            <div>
              <h1
                className="font-sans text-lg font-medium text-white tracking-wide cursor-pointer"
                onClick={() => onRefresh?.()}
              >
                KAMLIMOS
              </h1>
              <p className="text-[#8A8A8A] text-[10px] mt-1 uppercase tracking-wider font-medium">
                Admin System
              </p>
            </div>
          )}
          {collapsed && (
            <h1
              className="font-sans text-xl font-medium text-white tracking-wide cursor-pointer"
        ...
        <div className="hidden md:block">
          {collapsed && (
            <button
              onClick={() => setCollapsed(false)}
              className="mx-auto mb-4 text-[#8A8A8A] hover:text-white block"
            >
        ...
        <nav className="flex-1 px-4 space-y-1 mt-4">
          ...
          <div className="mb-6">
            ...
            >
              ...
              {!collapsed && <span>Finanzcockpit</span>}
            </Link>
          </div>
        ...
        <div className="p-4 border-t border-[#3A3A3A] mt-auto">
          ...
          >
            ...
            {!collapsed && (
              <span className="ml-3 font-medium text-sm">Abmelden</span>
            )}
          </button>
        </div>
      </div>
